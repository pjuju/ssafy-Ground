...
public class NotificationController {
    ...
    public void postNotifyAccount(@PathVariable Long toUserId, @RequestHeader String ftoken, @RequestBody boolean params){
    ...
    public List<NotificationAccountDto> getNotifyAccount(@RequestHeader String ftoken){
        User user = userRepository.findByUsername(jwtTokenProvider.getSubject(ftoken)).get();
    ...
    public void checkAllNotifyAccount(@RequestHeader String ftoken){
        User user = userRepository.findByUsername(jwtTokenProvider.getSubject(ftoken)).get();
        Long userId = user.getId();
    ...
    public void postNotifyBoard(@PathVariable Long boardId, @RequestHeader String ftoken, @RequestBody boolean params){
        User user = userRepository.findByUsername(jwtTokenProvider.getSubject(ftoken)).get();
        Long fromUserId = user.getId();
    ...
    public List<NotificationBoardDto> getNotifyBoard(@RequestHeader String ftoken){
        User user = userRepository.findByUsername(jwtTokenProvider.getSubject(ftoken)).get();
        Long userId = user.getId();
    ...
    public void checkAllNotifyBoard(@RequestHeader String ftoken){
        User user = userRepository.findByUsername(jwtTokenProvider.getSubject(ftoken)).get();
        Long userId = user.getId();
