...
function Navbar({ menu, onSetMenu }) {
  return (
    <div className="navbar">
      <Grid id="desktop" className="navbar-desktop" container direction="column">
        <Grid className="navbar-desktop__logo" item>
          <a href="/feed/follow"><img src={UnderLineLogo} /></a>
        </Grid>
        <Grid className="navbar-desktop__menu" >
          <h3 className="pulsate-fwd"><a href="/feed/follow">팔로우 피드</a></h3>
          <h3 className="pulsate-fwd"><a href="/">최신 글 피드</a></h3>
          <h3 className="pulsate-fwd"><a href="/">검색</a></h3>
